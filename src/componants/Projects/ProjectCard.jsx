...
import bannerImg from '../../assets/work_logo/cm.png';



const ProjectCard = ({title, main}) => {
  return (
    <div id='' className='p-3 md:p6 flex flex-col w-80 bg-[#0c0e19] shadow-xl shadow-slate-900 rounded-2xl text-white'>
